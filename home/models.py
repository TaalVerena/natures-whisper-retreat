...
class LodgeOverview(models.Model):
    ...
    This model contains basic information about a lodge, such as its name, description, and image.
    ...
    description = models.TextField(max_length=400, help_text="Enter a brief description of the lodge")
